...
describe "the is_multiple_of_3_or_5? method" do
    ...
    it "should return FALSE when an integer is NOT a multiple of 3 or 5" do
        ...
        expect(is_multiple_of_3_or_5?(1.23)).to eq(false)
        expect(is_multiple_of_3_or_5?("chiffre")).to eq(false)
    end
end

describe "the sum_of_3_and_5_multiples method" do
    it "should return 23 for an input of 10" do
        expect(sum_of_3_or_5_multiples(10)).to eq(23)
    end

    it "should return 33 for an input of 11" do
    ...
    it "should return a NO answer if the input is incorrect" do
